...
class SchemaValidator:
    ...
    def validate_fields(self, table_name: str, record: Dict) -> Dict:
        ...
        return {
            ...
            "suggestions": self._suggest_fields(table_name, invalid) if invalid else None
        }
    
    def _suggest_fields(self, table_name: str, invalid_fields: List[str]) -> Dict[str, List[str]]:
        """
        ...
        for invalid in invalid_fields:
            ...
            for field in valid:
                ...
                # Starts with match
                elif field_lower.startswith(invalid_lower) or invalid_lower.startswith(field_lower):
                    matches.append(field)
